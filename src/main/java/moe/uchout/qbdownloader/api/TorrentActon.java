...
public class TorrentActon implements BaseAction {
     ...
     * @throws QbException
     */
    private void post(HttpServerRequest req) throws QbException {
        ...
        try {
            ...
            throw new QbException("添加种子失败: " + e.getMessage(), e);
        }
    }
     ...
     * @throws QbException
     */
    private void put(HttpServerRequest req) throws QbException {
        try {
